...
public sealed class DuffelOffer
{
    ...
    [JsonPropertyName("owner")] public DuffelOwner? Owner { get; set; }
    [JsonPropertyName("slices")] public List<DuffelSlice>? Slices { get; set; }
}
public sealed class DuffelOwner { [JsonPropertyName("iata_code")] public string? IataCode { get; set; } [JsonPropertyName("name")] public string? Name { get; set; } }
public sealed class DuffelSlice { [JsonPropertyName("duration")] public string? Duration { get; set; } [JsonPropertyName("segments")] public List<DuffelSegment>? Segments { get; set; } }
public sealed class DuffelSegment
{
    ...
    [JsonPropertyName("origin")] public DuffelIataRef? Origin { get; set; }
    [JsonPropertyName("destination")] public DuffelIataRef? Destination { get; set; }
    [JsonPropertyName("duration")] public string? Duration { get; set; }
    [JsonPropertyName("marketing_carrier") ] public DuffelIataRef? MarketingCarrier { get; set; }
    [JsonPropertyName("marketing_carrier_flight_number")] public string? MarketingCarrierFlightNumber { get; set; }
}
public sealed class DuffelIataRef { [JsonPropertyName("iata_code")] public string? IataCode { get; set; } }
